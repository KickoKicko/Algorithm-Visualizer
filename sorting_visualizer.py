...
class sorting_visualizer:
    ...
    def update(self, pivot1=None, pivot2=None):
        ...
        column_width = ALL_COLUMN_WIDTH*(1+(1/(self.maxValue*3)))*(1/(self.maxValue*2))
        ...
        for i in range(len(self.list)):
            ...
            if pivot1:
                if i==pivot1:
                    pygame.draw.rect(self.screen,(255,0,0),((column_width+space_between_column_width)*i+50,850-((self.list[i]/self.maxValue)*800),column_width,(self.list[i]/self.maxValue)*800))
            if pivot2:
                if i==pivot2:
                    pygame.draw.rect(self.screen,(0,0,255),((column_width+space_between_column_width)*i+50,850-((self.list[i]/self.maxValue)*800),column_width,(self.list[i]/self.maxValue)*800))
